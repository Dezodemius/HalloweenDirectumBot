...
INSERT INTO Questions (Id, Text, CorrectChoiceId)VALUES (6, 'Какое число идёт следующим? 89, 144, 233, 377', 22);
...
INSERT INTO Questions (Id, Text, CorrectChoiceId)VALUES (19, 'Что это? ''/@\(\[A\-Za\-z0\-9\_\]\{1,15\}\)/ ''', 75);
